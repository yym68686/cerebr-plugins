...
const PLUGIN_MESSAGES = Object.freeze({
    'en-US': Object.freeze({
        ...
        history_delete_unavailable: 'This remote snapshot requires a delete credential and cannot be deleted anonymously.',
    ...
    'zh-CN': Object.freeze({
        ...
        history_delete_unavailable: '当前服务端要求删除凭证，这条远端快照暂时不能匿名删除。',
...
function canDeleteRemoteHistoryEntry(entry = {}) {
    return !!resolveHistoryRemoteLocation(entry);
}
    ...
    async setup(runtimeContext) {
        ...
        const uploadSnapshot = async () => {
            ...
            if (
                ...
                && canDeleteRemoteHistoryEntry(existingEntry)
            ) {
                try {
