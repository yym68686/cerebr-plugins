...
const PLUGIN_MESSAGES = Object.freeze({
    'en-US': Object.freeze({
        ...
        recent_exports_description: 'Search, paginate, open, copy, or delete saved export records.',
    ...
    'zh-CN': Object.freeze({
        ...
        recent_exports_description: '搜索、分页、打开、复制或删除已保存的导出记录。',
...
function createHistoryItem(item = {}) {
    ...
    return {
        id: normalizeString(item.id, buildHistoryEntryId({
            chatId,
            chatTitle,
            filename,
            shareUrl,
